...
**Consequence.** An install that already lost `mi_imaging` this way can recover it only from a Drive or folder backup made before the upgrade. Migration v6 (same release; Greg, 2026-09-11: "do what you think is best") re-invokes the idempotent v2, v3 and v4 bodies once, so an install stamped while locked gets its readings normalized and its seeds planted on the next unlock; an unaffected install sees no change.

**Related:** DEC-027 (P-02 interception design), A-08 (migration rails), A-12 (v2), OPEN-17b (v5), `npm run test:locked-migrations`.

## DEC-070: The landing page states a complex-care focus beginning with liver disease

**Status:** Settled (Greg, in chat, 2026-09-12: "Merge and push now")
...
**Related:** DEC-073 (framework line), the informational-tool disclaimer (locked copy, unchanged).


## DEC-071: The primary CTA moves from waiting-list framing to invited early access
...
## DEC-072: Founder provenance is stated on the public landing page
...
## DEC-073: "Organize. Educate. Prepare." is the product framework, scoped to brand level
...
**Related:** Clinical Safety Core v1.2 (safety language), DEC-070.


## DEC-074: The hero uses a static product image with a fictional-data caption
