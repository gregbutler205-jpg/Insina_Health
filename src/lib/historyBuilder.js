// History Builder engine (HISTORY_BUILDER_SPEC v1.1, DEC-P52 to DEC-P54).
...
// Absent or unmapped values resolve to 'skipped' (DEC-P54).
...
export function rankPrompt({ stores, attestations, hb, sessionId, now = new Date() }) {
  ...
  // Anchor exception (DEC-P54): before S1, appointment goal only, until chosen.
